...
| **audit_round** | R1 |
| **date** | 2026-06-03 |
| **invoke_snapshot** | `content/harness/invokes/by-task/portfolio-e2e-demo-qa-v1/invoke_20260603_22_r1_portfolio-e2e-demo-qa-v1.md` |
| **关联 SPEC** | `content/tasks/specs/SPEC-portfolio_demo_site_v1_zh.md` §6.4–6.7 · `投递冲刺_20260609_v1_zh.md` §2–§3.3 |
...
- content/tasks/active/task_portfolio_e2e_demo_qa_v1.md（ready_for_execute）
- content/harness/reviews/task_portfolio_e2e_demo_qa_v1_audit_R1_20260603.md（R1 零阻塞）
...
4. 落盘 invoke → content/harness/invokes/by-task/portfolio-e2e-demo-qa-v1/invoke_YYYYMMDD_30_*.md
