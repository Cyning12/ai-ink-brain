...
| SPEC | `content/tasks/specs/SPEC-portfolio_demo_site_v1_zh.md`（§4.5 · §5 · §6.5 · §7 W5） |
...
| invoke_snapshot | `content/harness/invokes/by-task/portfolio-content-sync-v1/invoke_20260601_10_portfolio-content-sync-v1.md` |
| prev_review | 无 |
| reviewer | Agent（22 帽） |
| date | 2026-06-01 |
...
- content/tasks/active/task_portfolio_content_sync_script_v1.md（全文 · 尤其「同步脚本约定」「本地 admin sync 烟测」）
- content/harness/reviews/task_portfolio_content_sync_v1_audit_R1_20260601.md（R1 放行 · notes N1–N3）
...
你必须完成：
1. 开帽 invoke → content/harness/invokes/by-task/portfolio-content-sync-v1/invoke_20260601_30_portfolio-content-sync-v1.md
