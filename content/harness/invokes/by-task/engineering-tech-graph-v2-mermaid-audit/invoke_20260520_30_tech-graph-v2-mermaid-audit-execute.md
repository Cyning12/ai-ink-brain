...
| task_paths | ai-ink-brain/content/tasks/active/task_engineering_tech_graph_v2_mermaid_audit_v1.md |
| related_review_or_none | ai-ink-brain/content/harness/reviews/task_engineering_tech_graph_v2_mermaid_audit_v1_audit_R1_20260520.md |
...
- 关联任务审核：
ai-ink-brain/content/harness/reviews/task_engineering_tech_graph_v2_mermaid_audit_v1_audit_R1_20260520.md
- 关联 SPEC：
ai-ink-brain/content/tasks/specs/SPEC-tech_graph_v2_frontend_parity_v1.md §4 W2

你必须完成：
0. **Invoke 快照**：将本 user 消息全文按 docs/harness/invokes/README.md 落盘至 ai-ink-brain/content/harness/invokes/（开帽一次即可）。
...
6. 关账：验收勾选 → git mv 至 content/tasks/done/ → 更新 PRIORITY_ROADMAP §2.2 T3 为 done（日期）。
