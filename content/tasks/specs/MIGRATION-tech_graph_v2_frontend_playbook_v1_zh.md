...
> **对照真值**：`content/tasks/specs/SPEC-tech_graph_v2_frontend_parity_v1.md`  
...
1. **`docs/_tech_graph/graph_v2_schema.md`**  
   - 从配对后端仓同文件 **摘录结构**；改「关联 task」为前端 `content/tasks/specs/SPEC-tech_graph_v2_frontend_parity_v1.md`。  
...
| `content/tasks/specs/SPEC-*.md` | §11 执行顺序 |
