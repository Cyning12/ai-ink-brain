...
> **task 真值**：[`content/tasks/active/task_portfolio_visitor_auth_v1.md`](../active/task_portfolio_visitor_auth_v1.md)  
...
- content/tasks/active/task_portfolio_visitor_auth_v1.md（harness_mode: looptask）
- content/tasks/specs/SPEC-portfolio_demo_site_v1_zh.md（§4.3 · §4.6.5 · §6.3 · §7 W3）
...
4. **CLOSE 必做**：填 task `### KPI（00）` · `git mv` → `content/tasks/done/` · 更新 `content/tasks/_views/done.md`
5. 换帽前：invoke §3 → `content/harness/invokes/by-task/portfolio-visitor-auth-v1/` → commit
...
落盘 `content/harness/reviews/task_portfolio_visitor_auth_v1_audit_R1_YYYYMMDD.md`
...
落盘 `content/tasks/reinspect_results/task_portfolio_visitor_auth_v1_reinspect_YYYYMMDD.md`
...
2. `git mv content/tasks/active/task_portfolio_visitor_auth_v1.md content/tasks/done/`
