...
> **task 草案**：[`content/tasks/active/task_portfolio_content_sync_script_v1.md`](../active/task_portfolio_content_sync_script_v1.md)
...
- content/tasks/active/task_portfolio_content_sync_script_v1.md（harness_mode: looptask）
- content/tasks/specs/SPEC-portfolio_demo_site_v1_zh.md（§4.5 · §6.5 · W5）
...
6. 换帽前：invoke §3 全文 → `content/harness/invokes/by-task/portfolio-content-sync-v1/` → commit
...
真值：22-task-audit.md · 落盘 content/harness/reviews/task_portfolio_content_sync_v1_audit_R1_YYYYMMDD.md
