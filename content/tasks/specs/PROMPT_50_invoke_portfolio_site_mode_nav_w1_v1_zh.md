...
> **落盘**：invoke → `content/harness/invokes/by-task/portfolio-site-mode-nav-v1/`；50 结论 → `content/tasks/reinspect_results/`
...
| --- | --- | --- |
| `{{TASK_PATH}}` | 子 task（相对 `Projects/`） | `ai-ink-brain/content/tasks/active/task_portfolio_site_mode_nav_v1.md` |
...
| `{{SPEC_PATH}}` | 冻结 SPEC | `ai-ink-brain/content/tasks/specs/SPEC-portfolio_demo_site_v1_zh.md` |
...
| 写 `content/tasks/reinspect_results/task_portfolio_site_mode_nav_v1_reinspect_*.md` | 判 fail W2/W3/W4/W5/W6 未交付项（须标 **defer · 非 W1 阻塞**） |
...
- 必读：
  - ai-ink-brain/content/tasks/active/task_portfolio_site_mode_nav_v1.md
  - task 内 ### 自检结论（执行者）
  - ai-ink-brain/content/tasks/specs/SPEC-portfolio_demo_site_v1_zh.md（§4.1 · §6.1 · §6.2 · §7 W1 行）
  - content/tasks/specs/PROMPT_50_invoke_portfolio_site_mode_nav_w1_v1_zh.md（本 W1 边界）
  - 22 审查：无（路径 B · 须声明风险）
...
- impl_commit：bed2baf
- 落盘：
  - reinspect → content/tasks/reinspect_results/task_portfolio_site_mode_nav_v1_reinspect_20260601.md
  - invoke 若缺 → content/harness/invokes/by-task/portfolio-site-mode-nav-v1/invoke_20260601_50_portfolio-site-mode-nav-v1.md
...
- content/tasks/specs/PROMPT_50_invoke_portfolio_site_mode_nav_w1_v1_zh.md（W1 边界 · defer 口径）
...
0. **Invoke 快照**：若 `content/harness/invokes/by-task/portfolio-site-mode-nav-v1/` 下无本次 50 快照，先将 **本消息全文** 落盘 `invoke_20260601_50_portfolio-site-mode-nav-v1.md` 后 commit。
...
- `content/tasks/reinspect_results/task_portfolio_site_mode_nav_v1_reinspect_20260601.md`
...
3. 勾选 task 验收；`git mv` → `content/tasks/done/`（**须**人改 `HG-REINSPECT: approved` 再 merge）  
