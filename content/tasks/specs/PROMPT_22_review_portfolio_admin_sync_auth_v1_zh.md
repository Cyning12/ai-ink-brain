...
> **落盘**：`content/harness/reviews/by-task/portfolio-admin-sync-auth/task_portfolio_admin_sync_auth_v1_audit_R1_YYYYMMDD.md`  
> **invoke 快照（可选）**：`content/harness/invokes/by-task/portfolio-admin-sync-auth/invoke_YYYYMMDD_22_portfolio-admin-sync-auth.md`
...
| 占位符 | 含义 | 默认值 |
| --- | --- | --- |
| `{{SPEC_PATH}}` | 冻结 SPEC | `content/tasks/specs/SPEC-portfolio_admin_sync_auth_v1_zh.md` |
...
| 只读 | `tools/README-portfolio-content-sync.md`、`content/tasks/active/task_portfolio_content_sync_script_v1.md`（烟测段） |
...
| 命令 | `rg 'NEXT_PUBLIC_ADMIN_SECRET|x-admin-token' tools/ content/tasks/active/task_portfolio_content_sync_script_v1.md content/tasks/specs/SPEC-portfolio_admin_sync_auth_v1_zh.md`（漂移 grep） |
...
- 禁止带入：主 Chat 实现过程全文
- 必读：
  - content/tasks/specs/SPEC-portfolio_admin_sync_auth_v1_zh.md（§2 实现真值 · §5 验收）
  ...
  - content/tasks/active/task_portfolio_content_sync_script_v1.md（烟测段）
  - docs/meta/PROJECT_CONFIG_AI_INK_BRAIN.md · .env.example · docs/_tech_graph/11_flow_api.md
- diff：git diff {{DIFF_BASE}} -- lib/auth/ app/api/admin/ lib/py-service-proxy.ts tools/README-portfolio-content-sync.md content/tasks/active/task_portfolio_content_sync_script_v1.md content/tasks/specs/SPEC-portfolio_admin_sync_auth_v1_zh.md docs/meta/PROJECT_CONFIG_AI_INK_BRAIN.md .env.example docs/_tech_graph/11_flow_api.md .cursor/skills/harness-looptask-handoff/

- 落盘：content/harness/reviews/by-task/portfolio-admin-sync-auth/task_portfolio_admin_sync_auth_v1_audit_R1_{{DATE}}.md
...
- content/tasks/specs/PROMPT_22_review_portfolio_admin_sync_auth_v1_zh.md §2–§3
- content/tasks/specs/SPEC-portfolio_admin_sync_auth_v1_zh.md（freeze_id PORTFOLIO-ADMIN-SYNC-AUTH@2026-06-01）
...
0. **Invoke 快照（可选）**：将本消息 §4+§5 全文落盘到 content/harness/invokes/by-task/portfolio-admin-sync-auth/invoke_{{DATE}}_22_portfolio-admin-sync-auth.md
