...
> **落盘**：`content/tasks/reinspect_results/task_portfolio_content_sync_v1_reinspect_YYYYMMDD.md`  
> **invoke**：`content/harness/invokes/by-task/portfolio-content-sync-v1/invoke_YYYYMMDD_50_*.md`
...
- prompt_spec: content/tasks/specs/PROMPT_50_invoke_portfolio_content_sync_w5_v1_zh.md

- 禁止带入：主 Chat 30 执行史全文
- 必读：
  - content/tasks/active/task_portfolio_content_sync_script_v1.md（含 ### 自检结论）
  - content/harness/reviews/task_portfolio_content_sync_v1_audit_R1_20260601.md
  - content/harness/reviews/task_portfolio_content_sync_v1_audit_R2_20260601.md
  - content/tasks/specs/SPEC-portfolio_demo_site_v1_zh.md（§4.5 · §6.5）
...
- 落盘：content/tasks/reinspect_results/task_portfolio_content_sync_v1_reinspect_20260601.md
