...
<!-- captured_at_utc: 2026-04-12T13:31:16.531319+00:00 -->
...
Extra keys can be included top-level in the content block or nested in `"extras": {"key": value}`.[OpenAI](/oss/python/integrations/chat/openai) and [AWS Bedrock Converse](/oss/python/integrations/chat/bedrock),
...
Previous](/oss/python/langchain/models)[Tools

Next](/oss/python/langchain/tools)
