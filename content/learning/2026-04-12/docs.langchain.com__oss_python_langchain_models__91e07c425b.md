...
<!-- captured_at_utc: 2026-04-12T13:31:09.915610+00:00 -->
...
- [Base URL and proxy settings](#base-url-and-proxy-settings)
- [Log probabilities](#log-probabilities)
- [Token usage](#token-usage)
- [Invocation config](#invocation-config)
...
When a model returns tool calls, you need to execute the tools and pass the results back to the model. This creates a conversation loop where the model can use tool results to generate its final response. LangChain includes [agent](/oss/python/langchain/agents) abstractions that handle this orchestration for you.Here’s a simple example of how to do this:
...
Previous](/oss/python/langchain/agents)[Messages

Next](/oss/python/langchain/messages)
