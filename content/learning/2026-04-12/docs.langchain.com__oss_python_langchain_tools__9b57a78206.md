...
<!-- captured_at_utc: 2026-04-12T13:31:20.546293+00:00 -->
...
- [Route with tools\_condition](#route-with-tools_condition)
...
### [​](#route-with-tools_condition) Route with tools\_condition
...
Previous](/oss/python/langchain/messages)[Short-term memory

Next](/oss/python/langchain/short-term-memory)
