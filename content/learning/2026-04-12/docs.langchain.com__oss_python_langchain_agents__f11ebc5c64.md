...
<!-- captured_at_utc: 2026-04-12T13:31:04.698891+00:00 -->
...
- [Defining state via state\_schema](#defining-state-via-state_schema)
- [Streaming](#streaming)
...
Tools can be specified as plain Python functions or coroutines.The [tool decorator](/oss/python/langchain/tools#create-tools) can be used to customize tool names, descriptions, argument schemas, and other properties.
...
#### [​](#defining-state-via-state_schema) Defining state via `state_schema`
...
Previous](/oss/python/langchain/philosophy)[Models

Next](/oss/python/langchain/models)
