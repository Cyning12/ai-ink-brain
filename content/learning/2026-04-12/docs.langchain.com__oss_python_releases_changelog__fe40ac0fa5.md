...
<!-- captured_at_utc: 2026-04-12T13:30:58.551829+00:00 -->
...
- [Reference](/oss/python/common-errors)

##### Releases

- [Versioning](/oss/python/versioning)
...
- [Release policy](/oss/python/release-policy)
- [Security](/oss/python/security-policy)

FiltersClear

langchaindeepagentslanggraphintegrations
...
## [​](#deepagents-v0-4) `deepagents` v0.4
...
Previous](/oss/python/versioning)[What's new in LangChain v1

Next](/oss/python/releases/langchain-v1)
