...
<!-- captured_at_utc: 2026-04-12T13:32:18.692926+00:00 -->
...
- [Overview](#overview)
- [Why do agents fail?](#why-do-agents-fail)
...
- [Selecting formats](#selecting-formats)
- [Tool context](#tool-context)
- [Reads](#reads)
- [Writes](#writes)
- [Life-cycle context](#life-cycle-context)
- [Example: Summarization](#example-summarization)
...
Previous](/oss/python/langchain/runtime)[Model Context Protocol (MCP)

Next](/oss/python/langchain/mcp)
