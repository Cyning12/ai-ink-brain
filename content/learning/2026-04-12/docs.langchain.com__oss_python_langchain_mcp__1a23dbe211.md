...
<!-- captured_at_utc: 2026-04-12T13:32:57.785313+00:00 -->
...
- [Multimodal tool content](#multimodal-tool-content)
- [Resources](#resources)
...
- [Accessing runtime context](#accessing-runtime-context)
- [State updates and commands](#state-updates-and-commands)
...
Previous](/oss/python/langchain/context-engineering)[Human-in-the-loop

Next](/oss/python/langchain/human-in-the-loop)
