...
Usage:
    ...
    python scripts/graph_yaml_compile.py --graph-id 10_flow_route # Generate 10_flow_route.md
    ...
    python scripts/graph_yaml_compile.py --check --graph-id 10_flow_route
"""
...
def generate_mermaid(data: dict) -> str:
    ...
    phase_nodes = [n for n in nodes if n in ("Q", "E", "U1", "U2")]
