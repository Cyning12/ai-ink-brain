...
| task_path | docs/tasks/active/task_portfolio_site_mode_nav_v1.md |
...
| prompt_spec | docs/tasks/specs/PROMPT_50_invoke_portfolio_site_mode_nav_w1_v1_zh.md |
| date | 20260601 |
...
- 必读：
  - docs/tasks/active/task_portfolio_site_mode_nav_v1.md
  - task ### 自检结论（执行者）
  - docs/tasks/specs/SPEC-portfolio_demo_site_v1_zh.md（§4.1 · §6.1 · §6.2）
  - docs/tasks/specs/PROMPT_50_invoke_portfolio_site_mode_nav_w1_v1_zh.md
...
- 模式：两者
- impl_commit：bed2baf
- 落盘：docs/tasks/reinspect_results/task_portfolio_site_mode_nav_v1_reinspect_20260601.md
...
输入：
- 主 task：docs/tasks/active/task_portfolio_site_mode_nav_v1.md
- SPEC：docs/tasks/specs/SPEC-portfolio_demo_site_v1_zh.md
- 子仓根：ai-ink-brain
- 模式：两者
- diff：git diff origin/main...HEAD -- lib/site-mode.ts lib/site-mode.test.ts app/_components/site-nav.tsx app/_components/home-modules.tsx app/layout.tsx docs/_tech_graph/
