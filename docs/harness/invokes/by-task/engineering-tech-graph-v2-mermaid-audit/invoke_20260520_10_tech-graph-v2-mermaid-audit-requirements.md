...
| task_paths | `ai-ink-brain/docs/tasks/active/task_engineering_tech_graph_v2_mermaid_audit_v1.md`（由本帽 **新建**） |
...
ai-ink-brain/docs/tasks/specs/MIGRATION-tech_graph_v2_frontend_playbook_v1_zh.md
...
ai-ink-brain/docs/tasks/active/task_engineering_tech_graph_v2_docs_and_scripts_v1.md
ai-ink-brain/docs/tasks/active/task_engineering_tech_graph_v2_ci_equivalence_v1.md

【是否按任务审核文档回填】
无

你必须完成：
0. Invoke：更新 docs/harness/invokes/by-task/engineering-tech-graph-v2-mermaid-audit/invoke_20260520_10_tech-graph-v2-mermaid-audit-requirements.mdby-task/engineering-tech-graph-v2-mermaid-audit/invoke_20260520_10_tech-graph-v2-mermaid-audit-requirements.md 修订记录（勿重复新建同名）。
1. 在 task/tech-graph-v2-mermaid-audit-v1 新建 docs/tasks/active/task_engineering_tech_graph_v2_mermaid_audit_v1.md（draft、test_strategy、failure_paths、freeze_id TECH_GRAPH_S2_FREEZE_20260519_V2_3、验收、非范围）。
