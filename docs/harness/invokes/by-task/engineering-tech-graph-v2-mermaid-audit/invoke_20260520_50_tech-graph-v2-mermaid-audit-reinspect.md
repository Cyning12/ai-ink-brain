...
| task_paths | `ai-ink-brain/docs/tasks/done/task_engineering_tech_graph_v2_mermaid_audit_v1.md` |
...
输入（占位符已填）：
- 主 task 路径：
ai-ink-brain/docs/tasks/done/task_engineering_tech_graph_v2_mermaid_audit_v1.md
- 子仓根：
...
| PR 范围禁令 | pass | `git diff --name-only origin/main...HEAD` 无 `package.json`/`quality.yml`/`_manifest.json`/`app/**` | **非阻塞**：含 `docs/harness/reviews/task_tech_graph_frontend_manifest_v1_audit_R1_20260520.md`（T5 并行线） |
