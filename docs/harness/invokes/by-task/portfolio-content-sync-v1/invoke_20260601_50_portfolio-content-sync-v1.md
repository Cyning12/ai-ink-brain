# Invoke 快照 · 50 独立复检 · portfolio-content-sync-v1（W5）

| 字段 | 值 |
|------|-----|
| hat_id | 50 |
| task_slug | portfolio-content-sync-v1 |
| task_path | docs/tasks/active/task_portfolio_content_sync_script_v1.md |
...
见 `docs/tasks/specs/PROMPT_50_invoke_portfolio_content_sync_w5_v1_zh.md` §4（impl_commit=a489aa7）
