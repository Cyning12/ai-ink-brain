...
| 概念 | 后端 | 本仓 |
|------|------|------|
| 任务单 | docs/tasks/active/ | docs/tasks/active/ |
| invoke | docs/harness/invokes/ | docs/harness/invokes/ + 工作区 Projects/docs/harness/ |
...
2. 何时可读：用户 @；docs/tasks/* 或 docs/harness/invokes/* 显式路径；排障锁定具体文件。
3. 真值：docs/_tech_graph/、docs/meta/、docs/tasks/、docs/tasks/specs/ > diary。
4. 落盘：易过时 → docs/diary/；长期结论 → _tech_graph / docs/tasks/done/ / 99_spec.md。
...
05：复制后端，替换 docs/tasks/active/ → docs/tasks/active/；docs/harness/invokes/ → docs/harness/invokes/。
...
| 日期 | 说明 |
| --- | --- |
| 2026-05-22 | 初版：由后端 Agent 生成，落盘 `docs/harness/invokes/` 供前端 Agent 续跑 |
