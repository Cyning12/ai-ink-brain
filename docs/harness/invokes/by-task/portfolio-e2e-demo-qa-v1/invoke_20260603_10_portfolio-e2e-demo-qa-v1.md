...
| **task_path** | `ai-ink-brain/docs/tasks/active/task_portfolio_e2e_demo_qa_v1.md` |
...
【已有材料路径】
ai-ink-brain/docs/tasks/active/task_portfolio_e2e_demo_qa_v1.md
ai-ink-brain/docs/tasks/specs/SPEC-portfolio_demo_site_v1_zh.md（§6.4 · §6.5 · §6.7 · §7 W6）
ai-ink-brain/docs/tasks/specs/投递冲刺_20260609_v1_zh.md（§2 五问 · §3.3 sync）
ai-ink-brain/docs/tasks/done/task_portfolio_unified_chat_ui_v1.md（W4 · 勿推翻）
...
ai-ink-brain/docs/harness/invokes/by-task/portfolio-e2e-demo-qa-v1/invoke_20260603_00_portfolio-e2e-demo-qa-v1.md
...
2. 更新 `docs/tasks/specs/PROMPT_looptask_startup_portfolio_w6_v1_zh.md` §2 前置表（若与 00 扫描不一致则修正）
...
| read_paths | 用途 |
|------------|------|
| `docs/tasks/active/task_portfolio_e2e_demo_qa_v1.md` | 主 task（须回写定稿） |
| `docs/tasks/specs/SPEC-portfolio_demo_site_v1_zh.md` | §6.4–6.7 · §7 W6 |
| `docs/tasks/specs/投递冲刺_20260609_v1_zh.md` | §2 · §3.3 |
