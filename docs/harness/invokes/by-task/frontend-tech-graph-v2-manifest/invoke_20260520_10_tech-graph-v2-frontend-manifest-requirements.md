...
| task_paths | `docs/tasks/active/task_engineering_tech_graph_frontend_manifest_v1.md`（v1.0 · 2026-05-20） |
...
| task_outcome | 2026-05-20：已产出 `docs/tasks/active/task_engineering_tech_graph_frontend_manifest_v1.md` v1.0；裁定 **扩展后端 manifest_check + quality CI** |
...
产出前端域 _manifest.json + manifest_check 方案 task：覆盖 app/**/page.tsx、app/api/**/route.ts、关键 env（对齐 docs/tasks/specs 与 PROJECT_CONFIG 叙述，勿依赖 docs/meta 若未入库 Git）。
...
1. 在 task/tech-graph-v2-frontend-manifest-v1 新建 docs/tasks/active/task_engineering_tech_graph_frontend_manifest_v1.md（Harness 字段齐全）。
