...
| **audit_review** | `ai-ink-brain/docs/harness/reviews/task_chatbi_v3_lowconf_rag_preview_frontend_v1_audit_R1_20260531.md` |
...
输入：
- 主 task：ai-ink-brain/docs/tasks/active/task_chatbi_v3_lowconf_rag_preview_frontend_v1.md
- 子仓 cwd：ai-ink-brain
- 模式：独立复检
- diff：git diff 72f8f0c^..72f8f0c（或 origin/main...HEAD 若已 rebase）
- 审查 R1：ai-ink-brain/docs/harness/reviews/task_chatbi_v3_lowconf_rag_preview_frontend_v1_audit_R1_20260531.md
- 40 自检 commit：6e71a14
- 实现 commit：72f8f0c

你必须完成：
0. Invoke 落盘：docs/harness/invokes/by-task/chatbi-v3-lowconf-rag-preview-frontend/invoke_20260531_50_*.md
...
5. 落盘：docs/tasks/reinspect_results/reinspect_chatbi-v3-lowconf-rag-preview-frontend_*.md
