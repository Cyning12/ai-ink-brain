...
- **LoopTask 启动 Prompt**：[`docs/tasks/specs/PROMPT_looptask_startup_portfolio_w5_v1_zh.md`](../specs/PROMPT_looptask_startup_portfolio_w5_v1_zh.md)  
...
| 帽 | 条件 | 落盘 |
|----|------|------|
| **50 Task 子代理** | ✅ 30–40 · R2 签收 | `docs/tasks/reinspect_results/task_portfolio_content_sync_v1_reinspect_*.md` |
...
**禁止 glob**：`content/diary/`、`docs/tasks/`、`docs/harness/`、`content/learning/` 不得作为 sync 源或目标。
...
| 鉴权 22 复查 | `docs/harness/reviews/by-task/portfolio-admin-sync-auth/task_portfolio_admin_sync_auth_v1_audit_R1_20260601.md` |
| 22 R2 审查 | `docs/harness/reviews/task_portfolio_content_sync_v1_audit_R2_20260601.md` |
| 50 复检 | `docs/tasks/reinspect_results/task_portfolio_content_sync_v1_reinspect_20260601.md`（**pass**） |
