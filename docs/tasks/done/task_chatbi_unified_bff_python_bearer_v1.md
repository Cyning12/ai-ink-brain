...
> **演进**：已收敛为 Unified **主路径** `Authorization: Bearer <ChatBI DB 明文>`；BFF **不再**对 Unified / verify / py/chat/history 执行 `requireAdminApiSecret`（详见 `docs/tasks/done/task_chatbi_fake_login_unlock_401_frontend_v1.md`）。  
