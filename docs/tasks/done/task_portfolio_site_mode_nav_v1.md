...
| 路径 | 帽 | 适用 | 说明 |
|------|-----|------|------|
| **A（默认推荐）** | **22 任务审核** | 与 Epic `test_strategy: recommended` 及 SPEC R4-5 一致 | 人审 task 草案 → 22 产出 `docs/harness/reviews/*_audit_R1_*.md` → 回填 task → 再 30 |
...
权威规格：[`docs/tasks/specs/SPEC-portfolio_demo_site_v1_zh.md`](../specs/SPEC-portfolio_demo_site_v1_zh.md) **§4.1** · **§6.1** · **§6.2**（导航/首页子集）· **§7 W1**。
...
| 依赖项 | 路径/说明 |
|--------|-----------|
| **冻结 SPEC（前端）** | [`docs/tasks/specs/SPEC-portfolio_demo_site_v1_zh.md`](../specs/SPEC-portfolio_demo_site_v1_zh.md) §4.1 · §6.1 · §6.2 · §7 W1 |
...
| **五问 chip 真值** | [`docs/tasks/specs/投递冲刺_20260609_v1_zh.md`](../specs/投递冲刺_20260609_v1_zh.md) §2（W4 实施；本 task 仅引用） |
...
| **Harness 50（W1）** | [`docs/tasks/specs/PROMPT_50_invoke_portfolio_site_mode_nav_w1_v1_zh.md`](../specs/PROMPT_50_invoke_portfolio_site_mode_nav_w1_v1_zh.md) · invoke `docs/harness/invokes/by-task/portfolio-site-mode-nav-v1/invoke_*_50_*.md` |
...
| 50 复检 | [`docs/tasks/reinspect_results/task_portfolio_site_mode_nav_v1_reinspect_20260601.md`](../reinspect_results/task_portfolio_site_mode_nav_v1_reinspect_20260601.md) · **建议合并** · pass 13 / fail 0 |
...
**关闭回溯**：`docs/harness/invokes/by-task/portfolio-site-mode-nav-v1/` · reinspect 见上表 50 行
