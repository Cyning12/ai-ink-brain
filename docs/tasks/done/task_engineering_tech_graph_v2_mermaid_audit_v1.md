...
| 依赖 | 路径 |
| --- | --- |
| Parity SPEC | `ai-ink-brain/docs/tasks/specs/SPEC-tech_graph_v2_frontend_parity_v1.md` |
| 迁移 Playbook | `ai-ink-brain/docs/tasks/specs/MIGRATION-tech_graph_v2_frontend_playbook_v1_zh.md` |
...
| T1 / T2（已落地） | `ai-ink-brain/docs/tasks/active/task_engineering_tech_graph_v2_docs_and_scripts_v1.md`、`task_engineering_tech_graph_v2_ci_equivalence_v1.md` |
| 路线图 | `docs/tech_graph/tasks/PRIORITY_ROADMAP_v1_zh.md` §2、§0 |
| 10 帽 Invoke | `docs/harness/invokes/by-task/engineering-tech-graph-v2-mermaid-audit/invoke_20260520_10_tech-graph-v2-mermaid-audit-requirements.mdby-task/engineering-tech-graph-v2-mermaid-audit/invoke_20260520_10_tech-graph-v2-mermaid-audit-requirements.md` |
...
6. **关账**：头部 `done（YYYY-MM-DD …）` → `git mv` 至 `docs/tasks/done/` → 更新 `_views` → **同 PR 或紧随文档 PR** 更新 `PRIORITY_ROADMAP_v1_zh.md` §2.2 T3。
...
| 项 | 内容 |
| --- | --- |
| 涉及文件 | `docs/_tech_graph/{00_main,10_flow_route,11_flow_api,12_flow_auth,13_flow_components}.{ai.md,md}`、`02_version.md`、`graph.json`；`docs/harness/invokes/by-task/engineering-tech-graph-v2-mermaid-audit/invoke_20260520_30_*.md`；本 task → `done/` |
...
【关联】
- Invoke：docs/harness/invokes/by-task/engineering-tech-graph-v2-mermaid-audit/invoke_20260520_10_tech-graph-v2-mermaid-audit-requirements.mdby-task/engineering-tech-graph-v2-mermaid-audit/invoke_20260520_10_tech-graph-v2-mermaid-audit-requirements.md
- SPEC：ai-ink-brain/docs/tasks/specs/SPEC-tech_graph_v2_frontend_parity_v1.md §4 W2
...
【task】docs/tasks/active/task_engineering_tech_graph_v2_mermaid_audit_v1.md
