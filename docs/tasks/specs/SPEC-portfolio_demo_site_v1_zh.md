...
| **类型** | 规格真值（`docs/tasks/specs/`）；实施拆为 `docs/tasks/active/task_*.md` |
...
| 路径 | 结果 |
| --- | --- |
| `docs/tasks/specs/投递冲刺_20260609_v1_zh.md` | **可读**（§2 五问真值） |
...
> **权威（已拍板）**：[`docs/tasks/specs/投递冲刺_20260609_v1_zh.md`](./投递冲刺_20260609_v1_zh.md) **§2**（Prompt 00 轮 2 · Q1=A）。下表 **chip 展示文案** 与计划 **提问列逐字一致**。
...
| F3 | loader 误扫 `docs/tasks/` 等 | **缺陷**；URL 不得泄露维护路径 |
...
| --- | --- | --- | --- |
| **W1** | `task_portfolio_site_mode_nav_v1` | **部分 done**（#47）：`site-mode` · 四链 NAV · `PORTFOLIO_MODULES`（**缺 evidence 卡**）· **§4.6.0/§4.6.1 未完** | 归档见 `docs/tasks/done/`；余量 **并入 W2** 或 W1 补丁 task |
...
| docs 投递计划（五问 §2 真值） | [`docs/tasks/specs/投递冲刺_20260609_v1_zh.md`](./投递冲刺_20260609_v1_zh.md) |
| SDD 多轮精神 | `ai-ink-brain-api-python/docs/spec/SPEC-SDD-Drafting-Intent-Rounds-v1_zh.md` |
| 参考 SPEC 结构 | `docs/tasks/specs/SPEC-tech_graph_v2_frontend_parity_v1.md` |
| **Prompt 00（细化本 SPEC）** | `docs/tasks/specs/PROMPT_00_SPEC-refine_portfolio_demo_site_v1_zh.md` |
