...
> **task 草案**：[`docs/tasks/active/task_portfolio_unified_chat_ui_v1.md`](../active/task_portfolio_unified_chat_ui_v1.md)  
...
- docs/tasks/active/task_portfolio_unified_chat_ui_v1.md（harness_mode: looptask）
- docs/tasks/specs/SPEC-portfolio_demo_site_v1_zh.md（§4.4 · §4.6.5 · §6.4 · §6.6 · §7 W4）
- docs/tasks/specs/投递冲刺_20260609_v1_zh.md（§2 五问 · chip 逐字）
- docs/tasks/done/task_portfolio_visitor_auth_v1.md（W3 · ChatBI unlock 主路径 · 勿推翻）
...
4. **CLOSE 必做**：KPI 表 · `git mv` active→done · 更新 `docs/tasks/_views/done.md` · HANDOFF_CLOSE_TRACE
5. 换帽前：invoke §3 → `docs/harness/invokes/by-task/portfolio-unified-chat-ui-v1/` → **commit**
...
落盘 `docs/harness/reviews/task_portfolio_unified_chat_ui_v1_audit_R1_YYYYMMDD.md`
...
落盘 `docs/tasks/reinspect_results/task_portfolio_unified_chat_ui_v1_reinspect_YYYYMMDD.md`
...
2. `git mv docs/tasks/active/task_portfolio_unified_chat_ui_v1.md docs/tasks/done/`
