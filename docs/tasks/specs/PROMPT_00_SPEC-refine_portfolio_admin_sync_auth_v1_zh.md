...
> **用途**：在 **冻结 `freeze_id` / 创建 `docs/tasks/active/task_*.md` 之前**，对 [`SPEC-portfolio_admin_sync_auth_v1_zh.md`](./SPEC-portfolio_admin_sync_auth_v1_zh.md) 做多轮 **人-Agent 对齐**；每轮固定三步：**读 → 问 → 改 SPEC**。  
...
| 占位符 | 含义 | 本 Epic 默认值 |
| --- | --- | --- |
| `{{SPEC_PATH}}` | 目标 SPEC | `docs/tasks/specs/SPEC-portfolio_admin_sync_auth_v1_zh.md` |
| `{{FRONTEND_SITE_SPEC}}` | Portfolio 站点 SPEC | `docs/tasks/specs/SPEC-portfolio_demo_site_v1_zh.md` |
...
| `{{PLANNING_DOC}}` | 投递计划 | `docs/tasks/specs/投递冲刺_20260609_v1_zh.md` |
...
| 只读 | `tools/README-portfolio-content-sync.md`、`docs/tasks/active/task_portfolio_content_sync_script_v1.md`（漂移段） |
...
- 创建 / 修改 `docs/tasks/active/task_*.md`（冻结后由人开 10 帽）
...
必读（按顺序）：
1. docs/tasks/specs/PROMPT_00_SPEC-refine_portfolio_admin_sync_auth_v1_zh.md（本文件 §2–§3）
2. docs/tasks/specs/SPEC-portfolio_admin_sync_auth_v1_zh.md
3. docs/tasks/specs/投递冲刺_20260609_v1_zh.md §3.3–§3.4
