...
> **task 草案**：[`docs/tasks/active/task_portfolio_content_pages_v1.md`](../active/task_portfolio_content_pages_v1.md)  
...
- docs/tasks/active/task_portfolio_content_pages_v1.md（harness_mode: looptask）
- docs/tasks/specs/SPEC-portfolio_demo_site_v1_zh.md（§4.2 · §4.6 · §6.2 · §6.2.1 · §7 W2）
...
6. 换帽前：invoke §3 全文 → `docs/harness/invokes/by-task/portfolio-content-pages-v1/` → commit
...
须补齐/确认：
- `getPortfolioDoc(category)` vs 扩展 `mdx-posts.ts` 的隔离策略（**禁止** 暴露 `docs/tasks/`、`docs/harness/`）
...
真值：22-task-audit.md · 落盘 `docs/harness/reviews/task_portfolio_content_pages_v1_audit_R1_YYYYMMDD.md`
...
落盘 `docs/harness/reviews/task_portfolio_content_pages_v1_audit_R2_YYYYMMDD.md` · 签收/关闭节 → 派 Task 50
...
落盘：`docs/tasks/reinspect_results/task_portfolio_content_pages_v1_reinspect_YYYYMMDD.md`
