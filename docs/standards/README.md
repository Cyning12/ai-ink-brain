# docs/standards（Ink 前端 · L2 编码规范）

> **L1 真值**（语言无关）：工作区 [`docs/standards/CODING_BASELINE_L1_v1_zh.md`](../../../docs/standards/CODING_BASELINE_L1_v1_zh.md)（**active**）  
> **本目录**：前端栈 **L2 扩展**；条文 ID `F-xx`，每条标注 `遵循 B-xx`。
