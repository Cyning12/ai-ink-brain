  ...
  return (
    <main className="mx-auto w-full max-w-5xl px-6 py-16">
      ...
      <p className="mt-4 max-w-2xl text-muted-foreground">
        默认展示 <code className="text-xs">docs/tasks/active</code> 与{" "}
        <code className="text-xs">docs/tasks/done</code> 下的{" "}
      ...
      {tasks.length === 0 ? (
        <div className="mt-10 rounded-2xl border border-border bg-card/40 px-5 py-6 text-sm text-muted-foreground">
          目前还没有任务文档。请在{" "}
          <code className="text-xs">docs/tasks/active</code> 下新增{" "}
          <code className="text-xs">.md/.mdx</code> 文件（完成后归档到{" "}
          <code className="text-xs">docs/tasks/done</code>，见{" "}
          <code className="text-xs">docs/tasks/README.md</code>）。
        </div>
      ) : (
