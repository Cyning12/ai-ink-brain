...
/** GET /api/ops/sessions/{session_id}/deliverables → Python GET /ops/sessions/{session_id}/deliverables */
export async function GET(
  ...
  return forwardOpsRequest(
    `/api/py/ops/sessions/${encodeURIComponent(session_id)}/deliverables`,
    { method: "GET" },
    request,
  );
}
